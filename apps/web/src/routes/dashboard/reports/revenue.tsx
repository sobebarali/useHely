...
export const Route = createFileRoute("/dashboard/reports/revenue")({
...
function RevenueReportsPage() {
	...
	const reportTypes: { id: ReportType; name: string; description: string }[] = [
		{
			id: "department-utilization",
			name: "Department Utilization",
			description:
				"Department resource utilization and operational efficiency metrics",
		},
		{
			id: "medicine-usage",
			name: "Medicine Usage Report",
			description: "Medicine dispensing and usage analytics by department",
		},
		{
			id: "prescription-summary",
			name: "Prescription Summary",
			description: "Summary of prescriptions issued including top medicines",
		},
		{
			id: "staff-summary",
			name: "Staff Summary",
			...
			<div className="flex items-center gap-4">
				...
				<div>
					...
					<p className="text-muted-foreground">
						Generate financial and operational analytics reports
					</p>
				</div>
			</div>
					...
					<Card key={report.id}>
						<CardHeader>
							<CardTitle className="flex items-center gap-2 text-lg">
								{report.id === "department-utilization" ? (
