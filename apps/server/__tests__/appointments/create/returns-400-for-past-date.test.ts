import { Patient, Role, Staff, User } from "@hms/db";
...
describe("POST /api/appointments - Returns 400 for past date", () => {
	...
	it("returns 400 when booking appointment in the past", async () => {
